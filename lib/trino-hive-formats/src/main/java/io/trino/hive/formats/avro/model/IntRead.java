...
public final class IntRead
        extends AvroReadAction
{
    private final Schema readSchema;
    private final Schema writeSchema;

    IntRead(Schema readSchema, Schema writeSchema)
    {
        ...
        verify(readSchema.getType() == Schema.Type.INT);
        verify(writeSchema.getType() == Schema.Type.INT);
    }
