...
import io.trino.hive.formats.avro.model.BoolRead;
        ...
        implements DatumReader<Optional<Page>>
{
            ...
            throws AvroTypeException
    {
        ...
        return switch (action) {
            ...
            case BoolRead __ -> BooleanBlockBuildingDecoder.INSTANCE;
            ...
            case ReadingUnionReadAction readingUnionReadAction -> {
                if (isSimpleNullableUnion(readingUnionReadAction.readSchema())) {
                    yield createBlockBuildingDecoderForAction(readingUnionReadAction.getActualAction(), typeManager);
                }
                else {
            ...
            extends BlockBuildingDecoder
    {
                ...
                throws AvroTypeException
        {
            ...
            elementBlockBuildingDecoder = createBlockBuildingDecoderForAction(arrayReadAction.getElementReadAction(), typeManager);
        }
            ...
            extends BlockBuildingDecoder
    {
                ...
                throws AvroTypeException
        {
            ...
            valueBlockBuildingDecoder = createBlockBuildingDecoderForAction(mapReadAction.getValueReadAction(), typeManager);
        }
            ...
            extends BlockBuildingDecoder
    {
...

        {
            ...
            buildSteps = new RowBuildingAction[recordReadAction.getFieldReadActions().length];
            int i = 0;
            for (RecordFieldReadAction fieldAction : recordReadAction.getFieldReadActions()) {
                buildSteps[i] = switch (fieldAction) {
                    case DefaultValueFieldRecordFieldReadAction defaultValueFieldRecordFieldReadAction -> new ConstantBlockAction(
                            getDefaultBlockBuilder(defaultValueFieldRecordFieldReadAction.getFieldSchema(),
                                    defaultValueFieldRecordFieldReadAction.getDefaultBytes(), typeManager),
                            defaultValueFieldRecordFieldReadAction.getOutputChannel());
                    case ReadFieldAction readFieldAction -> new BuildIntoBlockAction(createBlockBuildingDecoderForAction(readFieldAction.getReadAction(), typeManager),
                            readFieldAction.getOutputChannel());
                    case SkipFieldRecordFieldReadAction skipFieldRecordFieldReadAction -> new SkipSchemaBuildingAction(skipFieldRecordFieldReadAction.getSkipAction());
                };
                i++;
            }
        }
            ...
            extends BlockBuildingDecoder
    {
                ...
                throws AvroTypeException
        {
            ...
            blockBuildingDecoders = new BlockBuildingDecoder[writtenUnionReadAction.getWriteOptionReadActions().length];
            for (int i = 0; i < writtenUnionReadAction.getWriteOptionReadActions().length; i++) {
                blockBuildingDecoders[i] = createBlockBuildingDecoderForAction(writtenUnionReadAction.getWriteOptionReadActions()[i], typeManager);
            }
        }
            ...
            extends WriterUnionBlockBuildingDecoder
    {
                ...
                throws AvroTypeException
        {
            ...
            readUnionEquiv = writtenUnionReadAction.isUnionEqiv();
            List<Schema> readSchemas = writtenUnionReadAction.readSchema().getTypes();
            checkArgument(readSchemas.size() == writtenUnionReadAction.getWriteOptionReadActions().length, "each read schema must have resolvedAction For it");
            ...
            BlockBuildingDecoder
    {
                ...
                throws AvroTypeException
        {
            ...
            outputChannel = indexToChannel[readingUnionReadAction.getFirstMatch()];
            delegateBuilder = createBlockBuildingDecoderForAction(readingUnionReadAction.getActualAction(), avroTypeManager);
            totalChannels = (int) IntStream.of(indexToChannel).filter(i -> i >= 0).count();
        }
