...
public class DeltaLakeSparkMetastoreConfig
{
    ...
    public DeltaLakeSparkMetastoreConfig setHiveJdbcUrl(String hiveJdbcUrl)
    {
    ...
    public DeltaLakeSparkMetastoreConfig setUser(String user)
    {
        this.user = user;
        return this;
    }
    ...
    @ConfigDescription("Username for Spark SQL client")
    public DeltaLakeSparkMetastoreConfig setPassword(String password)
    {
    ...
    public DeltaLakeSparkMetastoreConfig setIsDatabricks(Boolean isDatabricks)
    {
