        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        Multibinder<SystemTable> systemTables = newSetBinder(binder, SystemTable.class);
        systemTables.addBinding().to(IcebergTablesSystemTable.class).in(Scopes.SINGLETON);
