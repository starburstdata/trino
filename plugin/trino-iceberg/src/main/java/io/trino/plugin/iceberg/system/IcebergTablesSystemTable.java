        ...
        implements SystemTable
{
            ...
            ConnectorSplit split)
    {
        ...
        for (SchemaTableName table : catalog.listIcebergTables(connectorSession, schemaFilter)) {
            result.addRow(table.getSchemaName(), table.getTableName());
        }
        // TODO: How can we do accessControl here? we would like to call io.trino.security.AccessControl.filterTables but it is not part of th SPI and cannot be easily.
