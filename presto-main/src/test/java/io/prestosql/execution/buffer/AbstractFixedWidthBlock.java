        ...
        implements Block
{
    ...
    protected AbstractFixedWidthBlock(int positionCount, int fixedSize, String encodingName)
    {
        if (fixedSize < 0) {
    ...
    public Block getSingleValueBlock(int position)
    {
        ...
        if (isNull(position)) {
            valueIsNull = new boolean[] {true};
        }

        return new FixedWidthBlock(fixedSize, 1, copy, valueIsNull, encodingName);
    }
