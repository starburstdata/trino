...
public class TestingBlockEncodingSerde
        implements BlockEncodingSerde
{
    private final Function<String, BlockEncoding> blockEncodingProvider;

    public TestingBlockEncodingSerde(Function<String, BlockEncoding> blockEncodingProvider)
    {
        this.blockEncodingProvider = requireNonNull(blockEncodingProvider, "blockEncodingProvider is null");
    }
    ...
    public Block readBlock(SliceInput input)
    {
        ...
        BlockEncoding blockEncoding = blockEncodingProvider.apply(encodingName);
