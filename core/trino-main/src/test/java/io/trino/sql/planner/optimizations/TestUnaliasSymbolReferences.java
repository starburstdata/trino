    ...
    public void testDynamicFilterIdUnAliased()
    {
        ...
        assertOptimizedPlan(
                ...
                (p, session, metadata) -> {
                    ...
                    return p.join(
                            INNER,
                            p.filter(TRUE_LITERAL, // additional filter to test recursive call
                                    p.filter(
                                            ExpressionUtils.and(
                                            ...
                                            p.tableScan(tableHandle(session, probeTable), ImmutableList.of(probeColumn1, probeColumn2),
                                                    ImmutableMap.of(probeColumn1, new TpchColumnHandle("nationkey", BIGINT),
                ...
                join(
                        ...
                        filter(TRUE_LITERAL, filter(TRUE_LITERAL, tableScan(probeTable, ImmutableMap.of("probeColumn1", "suppkey", "probeColumn2", "nationkey")))),
