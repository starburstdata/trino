...
public class PageTestUtils
{
    ...
    {
        return createPageWithRandomData(types, positionCount, true, false, primitiveNullRate, nestedNullRate, ImmutableList.of());
    }
    ...
    {
        return createPageWithRandomData(types, positionCount, true, false, primitiveNullRate, nestedNullRate, ImmutableList.of(DICTIONARY));
    }
    ...
    {
        return createPageWithRandomData(types, positionCount, true, false, primitiveNullRate, nestedNullRate, ImmutableList.of(RUN_LENGTH));
    }
            ...
            List<BlockAssertions.Encoding> wrappings)
    {
        ...
        for (int i = 0; i < channelCount; i++) {
            blocks.add(createRandomBlockForType(types.get(i), positionCount, primitiveNullRate, nestedNullRate, wrappings));
        }
