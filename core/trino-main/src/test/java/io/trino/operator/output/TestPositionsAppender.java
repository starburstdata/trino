...
import static io.trino.block.BlockAssertions.createIpAddressesBlock;
...
import static io.trino.block.BlockAssertions.createShortTimestampBlock;
...
import static io.trino.block.BlockAssertions.createUUIDsBlock;
...
public class TestPositionsAppender
{
    ...
    public void testMultipleRleWithDifferentValue(Type type, Block value1, Block value2)
    {
        List<BlockView> input = ImmutableList.of(
        ...
        return new Object[][]
                {
                        ...
                        {UUID, createUUIDsBlock(Int128.ZERO), createUUIDsBlock(Int128.ONE)},
                        {VARBINARY, createSlicesBlock(Slices.wrappedLongArray(0)), createSlicesBlock(Slices.wrappedLongArray(1))},
                        {createDecimalType(1), createShortDecimalsBlock("0"), createShortDecimalsBlock("1")},
