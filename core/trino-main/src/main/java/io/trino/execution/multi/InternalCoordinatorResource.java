...
import io.trino.execution.multi.InternalCoordinatorClient.IsQueryRegisteredResponse;
...
@Path("/v1/coordinator/internal")
public class InternalCoordinatorResource
{
    private final DispatchManager dispatchManager;
    private final QueryManager queryManager;

    @Inject
    public InternalCoordinatorResource(DispatchManager dispatchManager, QueryManager queryManager)
    {
    ...
    @POST
    @Produces(MediaType.APPLICATION_JSON)
    @Path("query/cancel/{queryId}")
    public void cancel(@PathParam("queryId") QueryId queryId)
    {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("query/fullInfo/{queryId}")
    public Optional<QueryInfo> getFullQueryInfo(@PathParam("queryId") QueryId queryId)
    {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("query/basicInfo/{queryId}")
    public BasicQueryInfo getQueryInfo(@PathParam("queryId") QueryId queryId)
    {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("query/registered/{queryId}")
    public IsQueryRegisteredResponse isQueryRegistered(@PathParam("queryId") QueryId queryId)
    {
        return new IsQueryRegisteredResponse(dispatchManager.isQueryRegistered(queryId));
    }
}
