...
public class VectorizedByteArraySingleArrayBigintGroupByHash
        implements GroupByHash
{
    private static final int INSTANCE_SIZE = instanceSize(VectorizedByteArraySingleArrayBigintGroupByHash.class);
    ...
    public VectorizedByteArraySingleArrayBigintGroupByHash(boolean outputRawHash, int expectedSize, UpdateMemory updateMemory, int stepSize)
    {
