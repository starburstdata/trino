        ...
        implements PositionsAppender
{
    ...
    private void reset()
    {
        initialEntryCount = calculateNewArraySize(positionCount);
        initialized = false;
    ...
    private void updateSize(long newPositionCount)
    {
        sizeInBytes += Int128ArrayBlock.SIZE_IN_BYTES_PER_POSITION * newPositionCount;
    }
