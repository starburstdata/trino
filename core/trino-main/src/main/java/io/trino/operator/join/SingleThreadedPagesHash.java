...
public final class SingleThreadedPagesHash
        implements PagesHash
{
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(SingleThreadedPagesHash.class).instanceSize();
    ...
    public SingleThreadedPagesHash(
