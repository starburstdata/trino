...
public interface PositionsAppender
{
    ...
    /**
     * Returns number of bytes retained by this instance in memory.
     * It includes unused memory.
     */
    long getRetainedSizeInBytes();

    /**
     * Returns the size of memory in bytes used by positions appended to this appender.
     */
    long getSizeInBytes();
}
