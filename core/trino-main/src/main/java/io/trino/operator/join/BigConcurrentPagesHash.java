...
public final class BigConcurrentPagesHash
        implements PagesHash
{
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(BigConcurrentPagesHash.class).instanceSize();
            ...
            int threadCount)
    {
        ...
        mask = hashSize - 1;
        key = new BigIntAtomicArray(hashSize);
        key.fill(-1);
