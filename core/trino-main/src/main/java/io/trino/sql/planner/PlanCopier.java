...
public final class PlanCopier
{
            ...
            extends SimplePlanRewriter<Void>
    {
        ...
        {
            return new AggregationNode(idAllocator.getNextId(), context.rewrite(node.getSource()), node.getAggregations(), node.getGroupingSets(), node.getPreGroupedSymbols(), node.getStep(), node.getHashSymbol(), node.getGroupIdSymbol(), node.getRawInputMaskSymbol());
        }
